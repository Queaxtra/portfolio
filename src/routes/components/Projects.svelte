<script lang="ts">
    ...
    onMount(async () => {
        ...
        projects = data.sort(() => Math.random() - Math.random()).slice(0, 4);
    });
</script>

<div class="container mx-auto p-4 text-center">
    <h1 class="relative mt-5 text-3xl font-semibold">Projects</h1>
    <p class="text-sm font-mono mt-5">Do you want to see all my projects? Then go ahead, <a href="/projects" class="font-bold">click here!</a></p>
    <div>
